...
/**
 * Applet containing the skeleton viewer. Interfaces with the gesture recognition system to
 * give the necessary SensorSnapshots to the thread updating the skeleton 
 * @author axelcdv
 *
 */
public class GestureRecognitionApplet extends JApplet{
	...
	private SkeletonViewerPanel _imgPanel;
	...
	public GestureRecognitionApplet(){
		...
		_imgPanel = new SkeletonViewerPanel();
...
class UpdateThread extends Thread{
	...
	protected SkeletonViewerPanel _vwPanel;
	
	public UpdateThread(SkeletonViewerPanel vwPanel){
